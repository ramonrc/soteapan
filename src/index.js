...
var Home = {
	...
	NarracionCafe,
	m("p", m("div", {class: "video-container"}, m("iframe", {src: "media/VideoCafe.mp4", allowfullscreen: "" } ))
        )))
    }
}
